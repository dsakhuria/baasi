                      ...
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="rounded-md bg-[#111] text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                              onClick={onClose}
                            >
                          ...
                          <div className="flex gap-10 my-8">
                            <div onClick={() => setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-75">
                              <div className="w-10 h-10 bg-[#111] rounded-full flex items-center justify-center">
                                <IoTrash className='text-[#cbcbcb]' size={20} />
                              </div>
                              <div className="text-sm font-light text-[#a2a2a2]">
                                Delete
                              </div>
                            </div>
                          </div>
